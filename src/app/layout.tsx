...
export const metadata: Metadata = {
  title: 'Superior School of Excellence | Empowering Minds, Shaping the Future',
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth" suppressHydrationWarning>
      ...
      <body className="bg-[#fcf9f8] text-[#1c1b1b] font-sans overflow-x-hidden antialiased selection:bg-[#c2f366] selection:text-[#0e3566]" suppressHydrationWarning>
        {children}
      </body>
    </html>
  );
